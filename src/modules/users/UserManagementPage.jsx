...
const ROLE_META = {
  ...
  preparation_unloader: { label: 'Preparation Unloader', category: 'Production', bg: 'bg-blue-50',   badge: 'bg-blue-100 text-blue-800',      accent: 'bg-blue-400'   },
  sewing_part_operator: { label: 'Sewing Part Operator', category: 'Production', bg: 'bg-blue-50',   badge: 'bg-blue-100 text-blue-800',      accent: 'bg-blue-400'   },
  ...
  quality_manager:    { label: 'Quality Manager',    category: 'Quality',       bg: 'bg-green-50',   badge: 'bg-green-100 text-green-800',    accent: 'bg-green-400'  },
  numbering_user:     { label: 'Numbering User',     category: 'Quality',       bg: 'bg-green-50',   badge: 'bg-green-100 text-green-800',    accent: 'bg-green-400'  },
  validation_user:    { label: 'Validation User',    category: 'Quality',       bg: 'bg-green-50',   badge: 'bg-green-100 text-green-800',    accent: 'bg-green-400'  },
