...
const ProtectedRoute = () => {
  ...
  try {
    ...
    const allowedRoles = ['factory_admin', 'store_manager', 'production_manager','cutting_operator' , 'line_loader' ,'validation_user', 'line_manager', 'supplier', 'accountant', 'hr_manager',  'checking_user','numbering_user'];   
