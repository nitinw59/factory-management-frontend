...
const PreparationManagerLayout = () => {
            ...
            <header className="bg-white shadow-md sticky top-0 z-20">
                <div className="container mx-auto px-6 py-3 flex justify-between items-center">
                    ...
                    <nav className="hidden md:flex items-center space-x-6">
                        <NavLink to="/preparation-manager/dashboard" className={({ isActive }) => `flex items-center text-sm font-medium ${isActive ? 'text-blue-600' : 'text-gray-600 hover:text-blue-600'}`}>
                            <LuLayoutDashboard className="mr-2" /> Preparation Queue
                        </NavLink>
                       
                        <NavLink to="/preparation-manager/summary" className="flex items-center w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
                ...
                {isMobileMenuOpen && (
                    <div className="md:hidden bg-white shadow-md">
                        <nav className="flex flex-col p-4 space-y-4">
                            <NavLink to="/preparation-manager/dashboard" onClick={closeMobileMenu} className="flex items-center w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
                                <LuLayoutDashboard className="mr-2" /> Preparation Queue
                            </NavLink>
...
export default PreparationManagerLayout;
